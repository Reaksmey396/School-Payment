...
<div class="w-full mt-20 py-4 bg-gray-200 rounded-2xl shadow-sm">
  <div class="max-w-7xl mx-auto">
    ...
    <p class="text-gray-500 mt-2">
      Browse our diverse range of departments and find the perfect fit for your academic journey.

      <!-- GRID -->
    <div class="grid md:grid-cols-2 mt-6 lg:grid-cols-3 gap-6">

      <!-- CARD 1 -->
      <div class="bg-gray-50 rounded-2xl shadow-sm overflow-hidden hover:shadow-lg transition">
